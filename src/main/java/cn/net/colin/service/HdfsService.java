...
import cn.net.colin.conf.HadoopConfig;
...
public class HdfsService {
    ...
    public FileSystem getFileSystem() throws Exception {
        ...
        FileSystem fileSystem = FileSystem.get(new URI(hadoopConfig.getDefaultFS()), configuration, hadoopConfig.getUserName());
        return fileSystem;
    }
    ...
    public byte[] openFileToBytes(String path) throws Exception {
        ...
        try {
            ...
            return readFullyToByteArray(inputStream);
        } finally {
            fs.close();
        }
    }
